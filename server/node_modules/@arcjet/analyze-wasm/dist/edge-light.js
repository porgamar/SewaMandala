...
async function moduleFromPath(path) {
	if (path === "arcjet_analyze_js_req.component.core.wasm") return componentCoreWasm;
	if (path === "arcjet_analyze_js_req.component.core2.wasm") return componentCore2Wasm;
	if (path === "arcjet_analyze_js_req.component.core3.wasm") return componentCore3Wasm;
